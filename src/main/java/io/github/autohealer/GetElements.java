...
public class GetElements {
    ...
    public static String c(String var0, String var1) {
        ...
        for(int var9 = 1; var9 <= 20; ++var9) {
            String var8 = var0 + "/preceding::*[" + var9 + "]";
    ...
    public String d(String var1) {
        if (!UIElements.driver.findElements(By.xpath(this.a(var1, "WebElement"))).isEmpty()) {
            String var2 = this.a(var1, "WebElement") + "/following-sibling::td[1]";
            if (!UIElements.driver.findElements(By.xpath(var2)).isEmpty()) {
                ...
                var2 = this.a(var1, "WebElement") + "/following::span[1]";
                if (!UIElements.driver.findElements(By.xpath(var2)).isEmpty()) {
    ...
    public static String e(String var0, String var1) {
        String var3 = "contains(@type, 'submit') or contains(@type, 'checkbox') or contains(@type, 'radio') or contains(@type, 'hidden')";
        var1 = c(var0, var1);
        ...
        if (b(var2, var1)) {
            ...
            if (b(var2, var1)) {
                ...
                var2 = var0 + "/following::" + var1 + "[not(" + var3 + ")]";
                if (b(var2, var1)) {
                    return var2;
                } else {
                    var2 = var0 + "/../following-sibling::" + var1 + "[not(" + var3 + ")]";
                    if (b(var2, var1)) {
                        return var2;
                    } else {
                        var2 = var0 + "/following-sibling::" + var1 + "[not(" + var3 + ")]";
                        if (b(var2, var1)) {
                            ...
                            var2 = var0 + "/preceding::" + var1 + "[not(" + var3 + ")]";
                            if (b(var2, var1)) {
                                return var2;
                            } else {
                                var2 = var0 + "/preceding-sibling::" + var1 + "[not(" + var3 + ")]";
                                if (b(var2, var1)) {
                                    return var2;
                                } else {
                                    var2 = var0 + "/../preceding-sibling::" + var1 + "[not(" + var3 + ")]";
                                    return b(var2, var1) ? var2 : var2;
                                }
                            }
                        }
                    }
